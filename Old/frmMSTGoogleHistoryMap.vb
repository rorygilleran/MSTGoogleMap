...
Public Class frmMSTGoogleHistoryMap
            ...
            If Value = True Then
                Try
                    If historyMapHandlersAdded = False Then
                        ...
                        'RouteEvents
                        AddHandler clsHistoryMapCallback.evtHistory_ClearModifyRoute, AddressOf ClearModifyRoute
            ...
            Try
                ...
                If Not thisGoogleHistoryObj Is Nothing Or Google_IsBufferZone = True Then
                    ...
                    Else
                        ...
                        'htmlFile = Application.StartupPath & "\GoogleHistoryMap.html"
                        FileOpen(1, HistoryHTML, OpenMode.Output, OpenAccess.Write, OpenShare.Shared)
                        Print(1, str_HTML)
                        FileClose(1)
                        GM_Browser.Navigate(HistoryHTML)
                        GM_Browser.BringToFront()
    ...
    Private Sub GM_Browser_DocumentCompleted(sender As Object, e As WebBrowserDocumentCompletedEventArgs) Handles GM_Browser.DocumentCompleted
        ...
        If HistoryArrayStr.Length > 0 Then
            GM_Browser.Document.InvokeScript("Load_Google_Map", New String() {HistoryArrayStr})
        Else
